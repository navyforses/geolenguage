  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-dark-400 mt-1">Real-time analysis of 10 major digital platforms</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="card">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-dark-400 text-sm">Total Platforms</p>
        ...
        <div className="card">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-dark-400 text-sm">Bullish Outlook</p>
        ...
        <div className="card">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-dark-400 text-sm">Bearish Outlook</p>
        ...
        <div className="card">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-dark-400 text-sm">Neutral Outlook</p>
